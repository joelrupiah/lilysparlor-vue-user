    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Create a Admin</h4>
                        <form class="form-sample">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <vs-button @click.prevent="createAdmin" color="dark" type="filled" size="small">
                                        Create Admin
                                    </vs-button>
...
export default {
    ...
    methods: {
        ...
        createAdmin(){
            Axios.post('http://127.0.0.1:8000/api/admin/create-admin', this.form)
                .then(() => {})
                .catch(() => {})
        }
    },
